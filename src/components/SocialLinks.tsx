...
const socials = [
  {
    label: "WhatsApp",
    href: "https://wa.me/919911115947?text=Hello!%20I%20would%20like%20to%20know%20more%20about%20Hotel%20Grand%20View.",
    icon: WhatsApp,
    bg: "bg-[hsl(142,70%,45%)]",
  },
  {
    label: "Instagram",
    href: "https://www.instagram.com/hotelgrandview/",
    icon: Instagram,
    bg: "bg-[hsl(330,70%,50%)]",
  },
  {
    label: "Facebook",
    href: "https://www.facebook.com/p/hotelgrandview",
    icon: Facebook,
    bg: "bg-[hsl(220,70%,50%)]",
  }
];
